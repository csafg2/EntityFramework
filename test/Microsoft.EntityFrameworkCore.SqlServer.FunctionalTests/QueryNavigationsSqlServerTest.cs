...
FROM [Customers] AS [c]",
        ...
        public override void GroupJoin_with_complex_subquery_and_LOJ_does_not_get_flattened2()
        {
            base.GroupJoin_with_complex_subquery_and_LOJ_does_not_get_flattened2();
